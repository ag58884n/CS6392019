    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                ...
                Glide.with(getActivity().getApplicationContext()).load("https://raw.githubusercontent.com/ag58884n/CS6392019/master/UISummerI/GAJJARADITYALandscapeInit.png.png")
